...
static const std::unordered_map<uint32_t, std::array<uint8_t, 16>> volkswagen_mqb_meb_crc_constants {
  ...
  {0x205, {0x19, 0x36, 0xD4, 0x1E, 0x80, 0x22, 0xF4, 0xB8, 0xAD, 0x41, 0x0B, 0x3F, 0x87, 0x42, 0x25, 0x40}},  // SAM_01
  {0x12DD54C9, {0xDE, 0xA9, 0x83, 0x0B, 0x0C, 0x64, 0x79, 0x44, 0x0F, 0xF6, 0xC6, 0xC7, 0x05, 0x45, 0xB7, 0x59}},  // SAL_01
};
